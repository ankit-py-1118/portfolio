  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-dosis" id="stack">
        ...
        <div className="flex flex-wrap justify-center mt-10">
          {content.stack.techs.map((tech, i) => {
            return (
              <span className={ `${i % 2 === 0 ? 'animate-bounce-slow' : 'animate-bounce-little-fast'} w-40 h-40 bg-white shadow-2xl m-2 rounded-full flex items-center p-5`}>
